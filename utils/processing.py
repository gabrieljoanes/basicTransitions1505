...
def get_transition_from_gpt(para_a, para_b, examples, model="gpt-4"):
    ...
    system_prompt = (
        ...
        "La transition doit être en rapport avec le contenu des paragraphes qu'elle relie. "
        "Par exemple, si le paragraphe suivant parle d'un événement sportif, la transition doit faire référence au sport. "
        "Si le paragraphe suivant parle d'un événement culturel, la transition doit faire référence à la culture. "
