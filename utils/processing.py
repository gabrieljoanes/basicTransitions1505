...
def get_transition_from_gpt(para_a, para_b, examples, model="gpt-4"):
    ...
    system_prompt = (
        ...
        "IMPORTANT : La transition DOIT ABSOLUMENT correspondre au sujet principal du paragraphe qui suit. "
        "Si le paragraphe parle de sécurité ou police, utilise une transition sur la sécurité. "
        "Si le paragraphe parle d'innovation, utilise une transition sur l'innovation. "
        "NE JAMAIS utiliser une transition sur le sport pour un sujet non-sportif, etc. "
        "Exemples de transitions appropriées : "
        "- Pour un événement sportif : 'Sur le plan sportif,', 'Dans le domaine sportif,', 'Côté sport,' "
        "- Pour un événement culturel : 'Sur la scène culturelle,', 'Dans le domaine artistique,', 'Côté culture,' "
        "- Pour un événement éducatif : 'Dans le monde de l'éducation,', 'Sur le plan académique,', 'Côté enseignement,' "
        "- Pour un événement d'innovation : 'Dans le domaine de l'innovation,', 'Sur le plan technologique,', 'Côté recherche,' "
        "- Pour un événement environnemental : 'Sur le plan écologique,', 'Dans le domaine environnemental,', 'Côté développement durable,' "
        "- Pour un événement de sécurité : 'Sur le plan sécuritaire,', 'Dans le domaine de la sécurité,', 'Côté maintien de l'ordre,' "
        "- Pour un événement politique : 'Sur le plan politique,', 'Dans le domaine institutionnel,', 'Côté gouvernance,' "
        "- Pour un événement économique : 'Sur le plan économique,', 'Dans le domaine financier,', 'Côté business,' "
